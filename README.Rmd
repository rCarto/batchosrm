...
An interface between R and the OSRM API. [OSRM](https://github.com/Project-OSRM/osrm-backend) is a routing service based on [OpenStreetMap](http://project-osrm.org) data.   

This single function package enables the fast computation of routes and is a much faster alternative to repeated calls to [`osrm::osrmRoute()`](https://github.com/riatelab/osrm). 
